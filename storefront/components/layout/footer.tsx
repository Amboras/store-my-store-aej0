      ...
      <div className="container-custom py-section-sm">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="inline-block">
              <span className="font-heading text-2xl font-semibold lowercase italic">
                aureum
              </span>
            ...
            <p className="mt-6 text-sm text-muted-foreground leading-relaxed max-w-xs">
              Small-batch specialty coffee, roasted to order and shipped within 48 hours. Sourced from family farms, brewed with care.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Aureum Coffee Co. All rights reserved.
          </p>
